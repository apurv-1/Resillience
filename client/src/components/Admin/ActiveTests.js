    ...
    <div className={classes.root}>
      <TableContainer component={Paper} elevation={4}>
        <Table className={classes.table} aria-label="customized table">
          ...
          <TableBody>
            {activeTest.length > 0 &&
              activeTest.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(({ _id, testId, testName, noOfQuestions, testDuration, forCorrect, forInCorrect }, index) => (
                <StyledTableRow key={index}>
                  ...
                  <StyledTableCell component="th" scope="row" align="right" onClick={() => setCurrentTest_id(_id)}>
      ...
      <Dialog open={openDeleteDialogue} onClose={() => setOpenDeleteDialogue(false)} aria-labelledby="dialog-title">
