...
import { Drawer, Button, List, Divider, ListItem, ListItemIcon, ListItemText, Avatar, Typography } from "@material-ui/core";
...
export default function SideNav() {
  ...
  return (
    <div>
      <ClearAllRoundedIcon onClick={handleDrawer} className={classes.icon} fontSize="large" color="secondary" />
        ...
        <div className={classes.list}>
          <List>
            ...
            <div className={classes.pic} style={{ display: "flex", justifyContent: "center" }}>
              <Avatar alt="profile-pic" src="https://res.cloudinary.com/rweb1/image/upload/v1599639734/resilience_default_lqmb3p.png" className={classes.avatar} />
            </div>
            <div className={classes.detailsDiv}>
              <Typography variant="h5" className={classes.name}>
                {userState.payload ? userState.payload.name : "loading..."}
              </Typography>
              <span className={classes.email}>{userState.payload ? userState.payload.email : "loading..."}</span>
            </div>
            ...
            <ThemeProvider theme={theme}>
              <div className={classes.button}>
                <Button variant="contained" color="primary" className={classes.margin} onClick={() => setSignOut(true)}>
                  Sign Out
                </Button>
