    ...
    <div className={classes.root}>
      <TableContainer component={Paper} elevation={4}>
        <Table className={classes.table} aria-label="customized table">
          ...
          <TableBody>
            {students.length > 0 &&
              students.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(({ _id, name, email, batch, attemptedTests, contact, createdAt }, index) => (
                <StyledTableRow key={index}>
                  ...
                  <StyledTableCell component="th" scope="row" align="right">
                    <Button variant="contained" color="secondary" size="small" startIcon={<PersonIcon />} onClick={() => history.push("/students/" + _id)}>
                      Profile
                    </Button>
                  </StyledTableCell>
                  {/* <StyledTableCell
