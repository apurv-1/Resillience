...
function Footer(props) {
	...
	return (
		<div className={classes.footerSection}>
			<img
				loading="lazy"
				src="https://res.cloudinary.com/rweb1/image/upload/v1600243280/Assets/images/design-footerrr1_wlvv2d.svg"
			...
			<div>
				<div className={classes.buttonPhone}>
					<WhatsAppIcon
						...
						onClick={() =>
							window.open(
								"https://wa.me/919321725155?text=Hi,%20I'm%20interested%20to%20know%20more%20about%20RESILLIENCE%20and%20book%20a%20Mentoring%20Session",
								"_blank"
							)
						}
					/>
				...
				<Grid
					...
					<Grid item md={3} sm={6} xs={12} className={classes.articles}>
						...
						{[
							...
							<Link
								style={{ marginTop: "16px", color: "#cccccc", textDecoration: "none" }}
								key={index}
								to={eachElement.to}
					...
					<Grid item md={3} sm={6} xs={12} className={classes.address}>
						...
						<p style={{ color: "#cccccc", lineHeight: 1.4 }}>
					...
					<Grid item md={3} sm={6} xs={12}>
						...
						<div className={classes.socialIcons}>
							<FacebookIcon
								className={classes.clickableIcon}
								onClick={() => window.open("https://www.facebook.com/resillience.in", "_blank")}
							/>
							<TwitterIcon
								className={classes.clickableIcon}
								onClick={() => window.open("https://twitter.com/resillience_in", "_blank")}
							/>
							<InstagramIcon
								className={classes.clickableIcon}
								onClick={() => window.open("https://www.instagram.com/resillience.in/", "_blank")}
							/>
							<YouTubeIcon
								className={classes.clickableIcon}
								onClick={() =>
									window.open("https://www.youtube.com/channel/UCLAs5bDSPA6e3EyWZ8bZsyg", "_blank")
								}
							/>
							<LinkedInIcon
								className={classes.clickableIcon}
								onClick={() => window.open("https://www.linkedin.com/company/resillience/", "_blank")}
							/>
						</div>
						{/* <br></br> */}
