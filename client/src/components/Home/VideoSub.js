        ...
        {["sh0EGUheef8", "1H72tRzG5TU", "cbBB-unybLA", "lv-YIJC1xWo", "PBwslCZRnaU", "w2zQ4lMFoMg", "gwNaLLQUHgs", "ubWLlaTN3Fw", "s6mvwNxPJ6g"].map((value, index) => (
          <div key={index}>
            <iframe
              ...
              srcDoc={`<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/${value}/?autoplay=1><img loading="lazy" src=https://img.youtube.com/vi/${value}/hqdefault.jpg alt='Resillience Teacher Videos'><span>▶</span></a>`}
            ></iframe>
          </div>
        ))}
      </Slider>
