...
export default function PrivacyPolicy() {
	...
	return (
		<div style={{ margin: "5%", marginBottom: "0%" }}>
			<h1 style={{ marginTop: "5rem" }}>Privacy Policy</h1>
			...
			<Accordion square expanded={expanded === "panel3"} onChange={handleChange("panel3")}>
				...
				<AccordionDetails>
					<Typography>
						...
						Resillience, Plot no B81, Anand Nagar MIDC, Additional Ambernath. , Ambernath, Dist : Thane –
						421506.
						<br />
						Cookies are small files that are placed on Your computer, mobile device or any other device by
						a website, containing the details of Your browsing history on that website among its many
						uses.
						<br />
						...
						<br />
						Website refers to RESILLIENCE, accessible from{" "}
						<a href="http://www.resillience.in">http://www.resillience.in</a>
						<br />
			...
			<Accordion square expanded={expanded === "panel18"} onChange={handleChange("panel18")}>
				...
				<AccordionDetails>
					<Typography>
						...
						on our website: <a href="resillience.in">resillience.in</a>
					</Typography>
				</AccordionDetails>
			</Accordion>
		</div>
