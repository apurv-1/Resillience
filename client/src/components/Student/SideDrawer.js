          ...
          <ThemeProvider theme={theme}>
            <List>
              ...
              <div className={classes.pic} style={{ display: "flex", justifyContent: "center" }}>
                <Avatar alt="profile-pic" src={userState.payload ? userState.payload.picture : <Loading />} className={classes.avatar} />
              </div>
              ...
              <div className={classes.button}>
                ...
                <Dialog open={signOut} onClose={() => setSignOut(false)} aria-labelledby="draggable-dialog-title">
