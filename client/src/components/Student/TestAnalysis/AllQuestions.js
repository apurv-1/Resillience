...
// 	setQuestions(cSubject.test.questions);
// 	setSelectedAnswers(cSubject.selectedAnswers);
// 	setTimeElapsed(cSubject.timeElapsed);
// 	console.log(cSubject);
// 	var timePerQuestion = parseInt(cSubject.test.testDuration / (questions.length * 1000));
// 	return (
// 		<div className={classes.root}>
// 			{questions.map(({ questionImage, correctOption, difficuilty, questionNumber, subject }, index) =>
// 				cSubject.cSubject !== "" ? (
