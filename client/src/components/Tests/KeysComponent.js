...
import { SET_CURRENT_INDEX, SET_SELECTED_ANSWERS, SET_SHOW_RESULTS, SET_IS_MARKED, SET_INCREMENT_TIME, SET_SUBJECT } from "../Reducers/types";
...
const KeysComponent = () => {
  ...
  const { test, currentIndex, selectedAnswers, showResult, isMarked, timeElapsed, isVisited, isStarted } = state;
  ...
  return (
    <div className={classes.buttonContainer}>
      ...
      <Button variant="contained" color="primary" className={classes.button} onClick={() => setOpenSubmitDialog(true)}>
        Submit Test
      </Button>
      <ThemeProvider theme={theme}>
        <Dialog open={openSubmitDialog} onClose={() => setOpenSubmitDialog(false)} aria-labelledby="alert-dialog-title">
